...
open class s3eGooglePlayServicesActivity() : com.ideaworks3d.marmalade.s3eGooglePlayServices.BaseGameActivity() {
    ...
    public fun incrementAchievement(p0: String, p1: Int, p2: Boolean): Boolean { return false }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun loadAchievements(): Boolean { return false }
    /*
    //         .locals 3
    //         const/4 v0, 0x0
    //         invoke-virtual {p0}, Lcom/ideaworks3d/marmalade/s3eGooglePlayServices/s3eGooglePlayServicesActivity;->isSignedIn()Z
    ...
    */
    ...
    public fun loadCurrentPlayerLeaderboardScore(p0: String, p1: Int, p2: Int): Boolean { return false }
    /*
    //         .locals 2
    //         invoke-virtual {p0}, Lcom/ideaworks3d/marmalade/s3eGooglePlayServices/s3eGooglePlayServicesActivity;->isSignedIn()Z
    //         move-result v0
    ...
    */
    ...
    public fun loadPlayerCenteredScores(p0: String, p1: Int, p2: Int, p3: Int, p4: Boolean): Boolean { return false }
    /*
    //         .locals 7
    //         invoke-virtual {p0}, Lcom/ideaworks3d/marmalade/s3eGooglePlayServices/s3eGooglePlayServicesActivity;->isSignedIn()Z
    //         move-result v0
    ...
    */
    ...
    public fun loadTopScores(p0: String, p1: Int, p2: Int, p3: Int, p4: Boolean): Boolean { return false }
    /*
    //         .locals 7
    //         invoke-virtual {p0}, Lcom/ideaworks3d/marmalade/s3eGooglePlayServices/s3eGooglePlayServicesActivity;->isSignedIn()Z
    //         move-result v0
    ...
    */
    ...
    override protected fun onCreate(p0: android.os.Bundle?) { /* TODO(body): (Landroid/os/Bundle;)V */ }
    /*
    //         .locals 2
    ...
    */
    ...
    override public fun onSignInFailed() { /* TODO(body): ()V */ }
    /*
    //         .locals 2
    //         const-string v0, "s3eGooglePlayGamesActivity"
    ...
    */
    ...
    override public fun onSignInSucceeded() { /* TODO(body): ()V */ }
    /*
    //         .locals 2
    //         const-string v0, "s3eGooglePlayGamesActivity"
    ...
    */
    ...
    override public fun onSignOut() { /* TODO(body): ()V */ }
    /*
    //         .locals 2
    //         const-string v0, "s3eGooglePlayGamesActivity"
    ...
    */
    ...
    override protected fun onStart() { /* TODO(body): ()V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun revealAchievement(p0: String, p1: Boolean): Boolean { return false }
    /*
    //         .locals 2
    //         invoke-virtual {p0}, Lcom/ideaworks3d/marmalade/s3eGooglePlayServices/s3eGooglePlayServicesActivity;->isSignedIn()Z
    //         move-result v0
    ...
    */
    ...
    public fun showAchievements(): Boolean { return false }
    /*
    //         .locals 3
    //         const-string v0, "s3eGooglePlayGamesActivity"
    ...
    */
    ...
    public fun showAllLeaderboards(): Boolean { return false }
    /*
    //         .locals 3
    //         const-string v0, "s3eGooglePlayGamesActivity"
    ...
    */
    ...
    public fun showLeaderboard(p0: String): Boolean { return false }
    /*
    //         .locals 3
    //         const-string v0, "s3eGooglePlayGamesActivity"
    //         const-string v1, "showLeaderboards"
    ...
    */
    ...
    public fun showMatchMakingInvitePlayersDialog(p0: Int, p1: Int, p2: Int): Boolean { return false }
    /*
    //         .locals 4
    //         const-string v0, "s3eGooglePlayGamesActivity"
    ...
    */
    ...
    public fun showMatchMakingInvitingListDialog(p0: Int): Boolean { return false }
    /*
    //         .locals 4
    //         const-string v0, "s3eGooglePlayGamesActivity"
    ...
    */
    ...
    public fun submitScore(p0: String, p1: Int, p2: Boolean): Boolean { return false }
    /*
    //         .locals 4
    //         invoke-virtual {p0}, Lcom/ideaworks3d/marmalade/s3eGooglePlayServices/s3eGooglePlayServicesActivity;->isSignedIn()Z
    //         move-result v0
    ...
    */
    ...
    public fun unlockAchievement(p0: String, p1: Boolean): Boolean { return false }
    /*
    //         .locals 2
    //         invoke-virtual {p0}, Lcom/ideaworks3d/marmalade/s3eGooglePlayServices/s3eGooglePlayServicesActivity;->isSignedIn()Z
    //         move-result v0
    ...
    */
    ...
    @JvmField public var singleton: com.ideaworks3d.marmalade.s3eGooglePlayServices.s3eGooglePlayServicesActivity? = null
