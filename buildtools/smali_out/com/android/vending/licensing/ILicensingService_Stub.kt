...
// Auto-emitted from smali source: ILicensingService.java.
// 2 fields, 4 methods.

open class ILicensingService_Stub: android.os.Binder(), com.android.vending.licensing.ILicensingService {
    public constructor()
    ...
    */
    ...
    companion object {
    private val DESCRIPTOR: String = "com.android.vending.licensing.ILicensingService"
    val TRANSACTION_checkLicense: Int = 0x1

    public @JvmStatic fun asInterface(p0: android.os.IBinder): com.android.vending.licensing.ILicensingService { return TODO("body: (Landroid/os/IBinder;)Lcom/android/vending/licensing/ILicensingService;") }
    /*
    //         .locals 2
    //         if-nez p0, :cond_0
    //         const/4 v0, 0x0
