...
// Auto-emitted from smali source: APKExpansionPolicy.java.
// 25 fields, 21 methods.

open class APKExpansionPolicy: com.android.vending.licensing.Policy {
    private var mExpansionFileNames: java.util.Vector
    private var mExpansionFileSizes: java.util.Vector
    private var mExpansionURLs: java.util.Vector
    ...
    */
    ...
    public fun getExpansionFileName(p0: Int): String { return TODO("body: (I)Ljava/lang/String;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getExpansionFileSize(p0: Int): Long { return TODO("body: (I)J") }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun getExpansionURL(p0: Int): String { return TODO("body: (I)Ljava/lang/String;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getExpansionURLCount(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    //         iget-object v0, p0, Lcom/android/vending/licensing/APKExpansionPolicy;->mExpansionURLs:Ljava/util/Vector;
    //         invoke-virtual {v0}, Ljava/util/Vector;->size()I
    ...
    */
    ...
    public fun resetPolicy() { /* TODO(body): ()V */ }
    /*
    //         .locals 3
    //         iget-object v0, p0, Lcom/android/vending/licensing/APKExpansionPolicy;->mPreferences:Lcom/android/vending/licensing/PreferenceObfuscator;
    //         const-string v1, "lastResponse"
    ...
    */
    ...
    public fun setExpansionFileName(p0: Int, p1: String) { /* TODO(body): (ILjava/lang/String;)V */ }
    /*
    //         .locals 2
    //         iget-object v0, p0, Lcom/android/vending/licensing/APKExpansionPolicy;->mExpansionFileNames:Ljava/util/Vector;
    //         invoke-virtual {v0}, Ljava/util/Vector;->size()I
    ...
    */
    ...
    public fun setExpansionFileSize(p0: Int, p1: Long) { /* TODO(body): (IJ)V */ }
    /*
    //         .locals 2
    //         iget-object v0, p0, Lcom/android/vending/licensing/APKExpansionPolicy;->mExpansionFileSizes:Ljava/util/Vector;
    //         invoke-virtual {v0}, Ljava/util/Vector;->size()I
    ...
    */
    ...
    public fun setExpansionURL(p0: Int, p1: String) { /* TODO(body): (ILjava/lang/String;)V */ }
    /*
    //         .locals 2
    //         iget-object v0, p0, Lcom/android/vending/licensing/APKExpansionPolicy;->mExpansionURLs:Ljava/util/Vector;
    //         invoke-virtual {v0}, Ljava/util/Vector;->size()I
    ...
    */
    ...
    private val DURATION: Long = 0x6ddd00L
    @JvmField public val MAIN_FILE_URL_INDEX: Int = 0x0
    private val MILLIS_PER_MINUTE: Long = 0xea60L
    @JvmField public val PATCH_FILE_URL_INDEX: Int = 0x1
    private val PREFS_FILE: String = "com.android.vending.licensing.APKExpansionPolicy"
    ...
    private val TAG: String = "APKExpansionPolicy"
    }
}
