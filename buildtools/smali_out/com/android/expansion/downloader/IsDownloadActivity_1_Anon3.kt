...
open class IsDownloadActivity_1_Anon3: android.view.View.OnClickListener {
    val this$1: com.android.expansion.downloader.IsDownloadActivity.1

    constructor(p0: com.android.expansion.downloader.IsDownloadActivity.1)

    public fun onClick(p0: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 1
    //         iget-object v0, p0, Lcom/android/expansion/downloader/IsDownloadActivity$1$3;->this$1:Lcom/android/expansion/downloader/IsDownloadActivity$1;
