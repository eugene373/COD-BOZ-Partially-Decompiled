...
open class TextInsertedDetails: com.google.android.gms.common.internal.safeparcel.SafeParcelable {
    val BR: Int
    val RL: Int
    val mIndex: Int

    constructor(versionCode: Int, index: Int, stringDataIndex: Int)
