...
open class ValuesSetDetails: com.google.android.gms.common.internal.safeparcel.SafeParcelable {
    val BR: Int
    val Rr: Int
    val Rs: Int
    val mIndex: Int

    constructor(versionCode: Int, index: Int, valueIndex: Int, valueCount: Int)
