...
open class r {
    companion object {
    public @JvmStatic fun a(p0: String, p1: String, p2: android.content.Context, p3: android.util.AttributeSet, p4: Boolean, p5: Boolean, p6: String): String { return TODO("body: (Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZLjava/lang/String;)Ljava/lang/String;") }
    /*
    //         .locals 6
    //         if-nez p3, :cond_2
    //         const/4 v0, 0x0
