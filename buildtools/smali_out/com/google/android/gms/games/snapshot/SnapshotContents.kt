...
class SnapshotContents: com.google.android.gms.common.internal.safeparcel.SafeParcelable {
    private val BR: Int
    private var Ox: com.google.android.gms.drive.Contents

    constructor(versionCode: Int, contents: com.google.android.gms.drive.Contents)

    public constructor(contents: com.google.android.gms.drive.Contents)

    private fun a(p0: Int, p1: ByteArray, p2: Int, p3: Int, p4: Boolean): Boolean { return TODO("body: (I[BIIZ)Z") }
    /*
    //         .locals 8
    //         const/4 v1, 0x1
    //         const/4 v2, 0x0
    ...
    */
    ...
    companion object {
    @JvmField public val CREATOR: com.google.android.gms.games.snapshot.SnapshotContentsCreator = null!!
    private val adg: Object = null!!
    }
}
