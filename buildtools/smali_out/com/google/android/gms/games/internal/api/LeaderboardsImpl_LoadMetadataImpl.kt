...
open class LeaderboardsImpl_LoadMetadataImpl: com.google.android.gms.games.Games.BaseGamesApiMethodImpl() {
    private constructor()

    constructor(x0: com.google.android.gms.games.internal.api.LeaderboardsImpl.1)

    public fun U(p0: com.google.android.gms.common.api.Status): com.google.android.gms.games.leaderboard.Leaderboards.LeaderboardMetadataResult { return TODO("body: (Lcom/google/android/gms/common/api/Status;)Lcom/google/android/gms/games/leaderboard/Leaderboards$LeaderboardMetadataResult;") }
    /*
    //         .locals 1
