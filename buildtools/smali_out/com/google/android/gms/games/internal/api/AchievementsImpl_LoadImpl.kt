...
open class AchievementsImpl_LoadImpl: com.google.android.gms.games.Games.BaseGamesApiMethodImpl() {
    private constructor()

    constructor(x0: com.google.android.gms.games.internal.api.AchievementsImpl.1)

    public fun J(p0: com.google.android.gms.common.api.Status): com.google.android.gms.games.achievement.Achievements.LoadAchievementsResult { return TODO("body: (Lcom/google/android/gms/common/api/Status;)Lcom/google/android/gms/games/achievement/Achievements$LoadAchievementsResult;") }
    /*
    //         .locals 1
