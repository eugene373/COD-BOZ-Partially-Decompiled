...
class MilestoneEntity: com.google.android.gms.common.internal.safeparcel.SafeParcelable, com.google.android.gms.games.quest.Milestone {
    private val BR: Int
    private val Wm: String
    private val Xu: String
    private val acO: Long
    private val acP: Long
    private val acQ: ByteArray
    private val mState: Int

    constructor(versionCode: Int, milestoneId: String, currentProgress: Long, targetProgress: Long, completionBlob: ByteArray, state: Int, eventId: String)

    public constructor(milestone: com.google.android.gms.games.quest.Milestone)
    ...
    */
    ...
    companion object {
    @JvmField public val CREATOR: com.google.android.gms.games.quest.MilestoneEntityCreator = null!!

    @JvmStatic fun a(p0: com.google.android.gms.games.quest.Milestone): Int { return TODO("body: (Lcom/google/android/gms/games/quest/Milestone;)I") }
    /*
    //         .locals 4
    //         const/4 v0, 0x5
    ...
    */
    ...
    @JvmStatic fun a(p0: com.google.android.gms.games.quest.Milestone, p1: Object): Boolean { return TODO("body: (Lcom/google/android/gms/games/quest/Milestone;Ljava/lang/Object;)Z") }
    /*
    //         .locals 6
    //         const/4 v0, 0x1
    //         const/4 v1, 0x0
    ...
    */
    ...
    @JvmStatic fun b(p0: com.google.android.gms.games.quest.Milestone): String { return TODO("body: (Lcom/google/android/gms/games/quest/Milestone;)Ljava/lang/String;") }
    /*
    //         .locals 4
