...
open class g_a_a: com.google.android.gms.maps.model.internal.g {
    private var lb: android.os.IBinder

    constructor(p0: android.os.IBinder)

    public fun a(p0: com.google.android.gms.maps.model.internal.g): Boolean { return TODO("body: (Lcom/google/android/gms/maps/model/internal/g;)Z") }
    /*
    //         .locals 6
    ...
    */
    ...
    public fun setHoles(holes: java.util.List) { /* TODO(body): (Ljava/util/List;)V */ }
    /*
    //         .locals 5
    //         invoke-static {}, Landroid/os/Parcel;->obtain()Landroid/os/Parcel;
    //         move-result-object v1
