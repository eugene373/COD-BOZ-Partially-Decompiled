...
open class h_a_a: com.google.android.gms.maps.model.internal.h {
    private var lb: android.os.IBinder

    constructor(p0: android.os.IBinder)

    public fun a(p0: com.google.android.gms.maps.model.internal.h): Boolean { return TODO("body: (Lcom/google/android/gms/maps/model/internal/h;)Z") }
    /*
    //         .locals 6
    ...
    */
    ...
    public fun clearTileCache() { /* TODO(body): ()V */ }
    /*
    //         .locals 5
    //         .annotation system Ldalvik/annotation/Throws;
    //             value = {
    ...
    */
    ...
    public fun setFadeIn(fadeIn: Boolean) { /* TODO(body): (Z)V */ }
    /*
    //         .locals 5
    //         const/4 v0, 0x0
    //         invoke-static {}, Landroid/os/Parcel;->obtain()Landroid/os/Parcel;
