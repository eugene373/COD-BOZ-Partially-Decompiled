...
open class ILocationSourceDelegate_a: android.os.Binder(), com.google.android.gms.maps.internal.ILocationSourceDelegate {
    public constructor()
    ...
    */
    ...
    companion object {
    public @JvmStatic fun aS(p0: android.os.IBinder): com.google.android.gms.maps.internal.ILocationSourceDelegate { return TODO("body: (Landroid/os/IBinder;)Lcom/google/android/gms/maps/internal/ILocationSourceDelegate;") }
    /*
    //         .locals 2
    //         if-nez p0, :cond_0
    //         const/4 v0, 0x0
