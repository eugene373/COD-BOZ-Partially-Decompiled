...
open class aw_Anon2: java.util.concurrent.Callable {
    val CY: ByteArray
    val avT: com.google.android.gms.wearable.internal.aw
    val avU: android.os.ParcelFileDescriptor

    constructor(p0: com.google.android.gms.wearable.internal.aw, p1: android.os.ParcelFileDescriptor, p2: ByteArray)
    ...
    */
    ...
    public fun qa(): Boolean { return TODO("body: ()Ljava/lang/Boolean;") }
    /*
    //         .locals 5
    //         const/4 v1, 0x3
