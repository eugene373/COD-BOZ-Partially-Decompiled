...
open class PreviewActivity: android.app.Activity() {
    public constructor()

    private fun d(p0: String, p1: String, p2: String) { /* TODO(body): (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V */ }
    /*
    //         .locals 3
