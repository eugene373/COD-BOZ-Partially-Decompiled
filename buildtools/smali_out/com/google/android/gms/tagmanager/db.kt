...
open class db: com.google.android.gms.tagmanager.ab {
    private val arH: String
    private val arI: org.apache.http.client.HttpClient
    private var arJ: com.google.android.gms.tagmanager.db.a
    private val arq: android.content.Context

    constructor(p0: org.apache.http.client.HttpClient, p1: android.content.Context, p2: com.google.android.gms.tagmanager.db.a)

    private fun a(p0: java.net.URL): org.apache.http.HttpEntityEnclosingRequest { return TODO("body: (Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;") }
    /*
    //         .locals 5
    //         const/4 v1, 0x0
    //         :try_start_0
    ...
    */
    ...
    fun d(p0: com.google.android.gms.tagmanager.ap): java.net.URL { return TODO("body: (Lcom/google/android/gms/tagmanager/ap;)Ljava/net/URL;") }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun j(p0: java.util.List) { /* TODO(body): (Ljava/util/List;)V */ }
    /*
    //         .locals 10
    ...
    */
    ...
    companion object {
    @JvmStatic fun c(p0: java.util.Locale): String { return TODO("body: (Ljava/util/Locale;)Ljava/lang/String;") }
    /*
    //         .locals 3
    //         const/4 v0, 0x0
    //         if-nez p0, :cond_1
