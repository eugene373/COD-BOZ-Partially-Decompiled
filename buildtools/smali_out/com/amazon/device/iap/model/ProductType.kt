...
// Auto-emitted from smali source: ProductType.java.
// 4 fields, 4 methods.
...
enum class ProductType {
    ...
    companion object {
    public @JvmStatic fun valueOf(p0: String): com.amazon.device.iap.model.ProductType { return TODO("body: (Ljava/lang/String;)Lcom/amazon/device/iap/model/ProductType;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public @JvmStatic fun values(): Array<com.amazon.device.iap.model.ProductType> { return TODO("body: ()[Lcom/amazon/device/iap/model/ProductType;") }
    /*
    //         .locals 1
