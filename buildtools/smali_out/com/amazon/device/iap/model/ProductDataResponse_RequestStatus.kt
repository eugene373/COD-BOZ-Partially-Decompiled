...
enum class ProductDataResponse_RequestStatus {
    FAILED,
    NOT_SUPPORTED,
    SUCCESSFUL,
    ;
    ...
    companion object {
    public @JvmStatic fun valueOf(p0: String): com.amazon.device.iap.model.ProductDataResponse.RequestStatus { return TODO("body: (Ljava/lang/String;)Lcom/amazon/device/iap/model/ProductDataResponse$RequestStatus;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public @JvmStatic fun values(): Array<com.amazon.device.iap.model.ProductDataResponse.RequestStatus> { return TODO("body: ()[Lcom/amazon/device/iap/model/ProductDataResponse$RequestStatus;") }
    /*
    //         .locals 1
