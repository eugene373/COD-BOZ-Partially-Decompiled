...
// Auto-emitted from smali source: GetItemDataCommandV2.java.
// 1 fields, 4 methods.

class a: com.amazon.device.iap.internal.b.c.c() {
    public constructor(p0: com.amazon.device.iap.internal.b.e, p1: java.util.Set)

    private fun a(p0: String, p1: java.util.Map): com.amazon.device.iap.model.Product { return TODO("body: (Ljava/lang/String;Ljava/util/Map;)Lcom/amazon/device/iap/model/Product;") }
    /*
    //         .locals 8
