...
// Auto-emitted from smali source: LikeBoxCountView.java.
// 8 fields, 8 methods.

open class LikeBoxCountView: android.widget.FrameLayout() {
    private var additionalTextPadding: Int
    private var borderPaint: android.graphics.Paint
    private var borderRadius: Float
    private var caretHeight: Float
    private var caretPosition: com.facebook.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition
    private var caretWidth: Float
    private var likeCountLabel: android.widget.TextView
    private var textPadding: Int

    public constructor(p0: android.content.Context)

    private fun drawBorder(p0: android.graphics.Canvas, p1: Float, p2: Float, p3: Float, p4: Float) { /* TODO(body): (Landroid/graphics/Canvas;FFFF)V */ }
    /*
    //         .locals 7
    ...
    */
    ...
    private fun initializeLikeCountLabel(p0: android.content.Context) { /* TODO(body): (Landroid/content/Context;)V */ }
    /*
    //         .locals 4
    //         const/4 v1, -0x1
    ...
    */
    ...
    private fun setAdditionalTextPadding(p0: Int, p1: Int, p2: Int, p3: Int) { /* TODO(body): (IIII)V */ }
    /*
    //         .locals 5
    //         iget-object v0, p0, Lcom/facebook/internal/LikeBoxCountView;->likeCountLabel:Landroid/widget/TextView;
    ...
    */
    ...
    public fun setCaretPosition(p0: com.facebook.internal.LikeBoxCountView.LikeBoxCountViewCaretPosition) { /* TODO(body): (Lcom/facebook/internal/LikeBoxCountView$LikeBoxCountViewCaretPosition;)V */ }
    /*
    //         .locals 3
    //         const/4 v2, 0x0
    ...
    */
    ...
    public fun setText(p0: String) { /* TODO(body): (Ljava/lang/String;)V */ }
    /*
    //         .locals 1
    //         iget-object v0, p0, Lcom/facebook/internal/LikeBoxCountView;->likeCountLabel:Landroid/widget/TextView;
