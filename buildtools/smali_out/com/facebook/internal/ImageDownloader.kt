...
open class ImageDownloader {
    ...
    companion object {
    private val CACHE_READ_QUEUE_MAX_CONCURRENT: Int = 0x2
    private val DOWNLOAD_QUEUE_MAX_CONCURRENT: Int = 0x8
    private var cacheReadQueue: com.facebook.internal.WorkQueue
    private var downloadQueue: com.facebook.internal.WorkQueue
    private var handler: android.os.Handler
    private val pendingRequests: java.util.Map = null!!

    public @JvmStatic fun cancelRequest(p0: com.facebook.internal.ImageRequest): Boolean { return TODO("body: (Lcom/facebook/internal/ImageRequest;)Z") }
    /*
    //         .locals 5
    //         const/4 v1, 0x1
    //         const/4 v2, 0x0
    ...
    */
    ...
    public @JvmStatic fun clearCache(p0: android.content.Context) { /* TODO(body): (Landroid/content/Context;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    private @JvmStatic fun download(p0: com.facebook.internal.ImageDownloader.RequestKey, p1: android.content.Context) { /* TODO(body): (Lcom/facebook/internal/ImageDownloader$RequestKey;Landroid/content/Context;)V */ }
    /*
    //         .locals 11
    //         const/4 v3, 0x0
    //         const/4 v2, 0x0
    ...
    */
    ...
    public @JvmStatic fun downloadAsync(p0: com.facebook.internal.ImageRequest) { /* TODO(body): (Lcom/facebook/internal/ImageRequest;)V */ }
    /*
    //         .locals 3
    //         if-nez p0, :cond_0
    //         :goto_0
    ...
    */
    ...
    private @JvmStatic fun enqueueCacheRead(p0: com.facebook.internal.ImageRequest, p1: com.facebook.internal.ImageDownloader.RequestKey, p2: Boolean) { /* TODO(body): (Lcom/facebook/internal/ImageRequest;Lcom/facebook/internal/ImageDownloader$RequestKey;Z)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    private @JvmStatic fun enqueueDownload(p0: com.facebook.internal.ImageRequest, p1: com.facebook.internal.ImageDownloader.RequestKey) { /* TODO(body): (Lcom/facebook/internal/ImageRequest;Lcom/facebook/internal/ImageDownloader$RequestKey;)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    private @JvmStatic fun enqueueRequest(p0: com.facebook.internal.ImageRequest, p1: com.facebook.internal.ImageDownloader.RequestKey, p2: com.facebook.internal.WorkQueue, p3: Runnable) { /* TODO(body): (Lcom/facebook/internal/ImageRequest;Lcom/facebook/internal/ImageDownloader$RequestKey;Lcom/facebook/internal/WorkQueue;Ljava/lang/Runnable;)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    private @JvmStatic fun issueResponse(p0: com.facebook.internal.ImageDownloader.RequestKey, p1: Exception, p2: android.graphics.Bitmap, p3: Boolean) { /* TODO(body): (Lcom/facebook/internal/ImageDownloader$RequestKey;Ljava/lang/Exception;Landroid/graphics/Bitmap;Z)V */ }
    /*
    //         .locals 7
    //         invoke-static {p0}, Lcom/facebook/internal/ImageDownloader;->removePendingRequest(Lcom/facebook/internal/ImageDownloader$RequestKey;)Lcom/facebook/internal/ImageDownloader$DownloaderContext;
    //         move-result-object v0
    ...
    */
    ...
    public @JvmStatic fun prioritizeRequest(p0: com.facebook.internal.ImageRequest) { /* TODO(body): (Lcom/facebook/internal/ImageRequest;)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    private @JvmStatic fun readFromCache(p0: com.facebook.internal.ImageDownloader.RequestKey, p1: android.content.Context, p2: Boolean) { /* TODO(body): (Lcom/facebook/internal/ImageDownloader$RequestKey;Landroid/content/Context;Z)V */ }
    /*
    //         .locals 5
    //         const/4 v2, 0x0
    //         const/4 v0, 0x0
    ...
    */
    ...
    private @JvmStatic fun removePendingRequest(p0: com.facebook.internal.ImageDownloader.RequestKey): com.facebook.internal.ImageDownloader.DownloaderContext { return TODO("body: (Lcom/facebook/internal/ImageDownloader$RequestKey;)Lcom/facebook/internal/ImageDownloader$DownloaderContext;") }
    /*
    //         .locals 2
    //         sget-object v1, Lcom/facebook/internal/ImageDownloader;->pendingRequests:Ljava/util/Map;
    //         monitor-enter v1
