...
open class RequestProgress {
    ...
    constructor(p0: android.os.Handler, p1: com.facebook.Request)
    ...
    */
    ...
    fun addToMax(p0: Long) { /* TODO(body): (J)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    fun getProgress(): Long { return TODO("body: ()J") }
    /*
    //         .locals 2
    //         iget-wide v0, p0, Lcom/facebook/RequestProgress;->progress:J
    //         return-wide v0
    */
    ...
    fun reportProgress() { /* TODO(body): ()V */ }
    /*
    //         .locals 8
    //         iget-wide v0, p0, Lcom/facebook/RequestProgress;->progress:J
    //         iget-wide v2, p0, Lcom/facebook/RequestProgress;->lastReportedProgress:J
