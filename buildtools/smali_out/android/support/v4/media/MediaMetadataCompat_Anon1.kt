...
class MediaMetadataCompat_Anon1: android.os.Parcelable.Creator {
    constructor()

    public fun createFromParcel(in: android.os.Parcel): android.support.v4.media.MediaMetadataCompat { return TODO("body: (Landroid/os/Parcel;)Landroid/support/v4/media/MediaMetadataCompat;") }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun newArray(size: Int): Array<android.support.v4.media.MediaMetadataCompat> { return TODO("body: (I)[Landroid/support/v4/media/MediaMetadataCompat;") }
    /*
    //         .locals 1
