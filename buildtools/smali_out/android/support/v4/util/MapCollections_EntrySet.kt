...
class MapCollections_EntrySet: java.util.Set {
    val this$0: android.support.v4.util.MapCollections

    constructor(p0: android.support.v4.util.MapCollections)

    public fun add(x0: Object): Boolean { return TODO("body: (Ljava/lang/Object;)Z") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun add(p0: java.util.Map.Entry): Boolean { return TODO("body: (Ljava/util/Map$Entry;)Z") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun contains(o: Object): Boolean { return TODO("body: (Ljava/lang/Object;)Z") }
    /*
    //         .locals 6
    //         .local p0, "this":Landroid/support/v4/util/MapCollections$EntrySet;, "Landroid/support/v4/util/MapCollections<TK;TV;>.EntrySet;"
    //         const/4 v3, 0x0
