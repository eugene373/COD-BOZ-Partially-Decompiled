...
// Auto-emitted from smali source: ListViewAutoScrollHelper.java.
// 1 fields, 4 methods.

open class ListViewAutoScrollHelper: android.support.v4.widget.AutoScrollHelper() {
    private val mTarget: android.widget.ListView

    public constructor(target: android.widget.ListView)

    public fun canTargetScrollHorizontally(direction: Int): Boolean { return TODO("body: (I)Z") }
    /*
    //         .locals 1
    //         const/4 v0, 0x0
    //         return v0
    */
    ...
    public fun canTargetScrollVertically(direction: Int): Boolean { return TODO("body: (I)Z") }
    /*
    //         .locals 10
    //         const/4 v7, 0x0
    ...
    */
    ...
    public fun scrollTargetBy(deltaX: Int, deltaY: Int) { /* TODO(body): (II)V */ }
    /*
    //         .locals 5
