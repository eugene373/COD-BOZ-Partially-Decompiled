...
// 25 fields, 67 methods.

open class SlidingPaneLayout: android.view.ViewGroup() {
    private var mCanSlide: Boolean
    private var mCoveredFadeColor: Int
    private val mDragHelper: android.support.v4.widget.ViewDragHelper
    ...
    private var mPanelSlideListener: android.support.v4.widget.SlidingPaneLayout.PanelSlideListener
    private var mParallaxBy: Int
    private var mParallaxOffset: Float
    private val mPostedRunnables: java.util.ArrayList
    private var mPreservedOpenState: Boolean
    private var mShadowDrawableLeft: android.graphics.drawable.Drawable
    private var mShadowDrawableRight: android.graphics.drawable.Drawable
    private var mSlideOffset: Float
    private var mSlideRange: Int
    private var mSlideableView: android.view.View
    private var mSliderFadeColor: Int
    ...
    private fun closePane(pane: android.view.View, initialVelocity: Int): Boolean { return TODO("body: (Landroid/view/View;I)Z") }
    /*
    //         .locals 2
    //         const/4 v0, 0x0
    ...
    */
    ...
    private fun dimChildView(v: android.view.View, mag: Float, fadeColor: Int) { /* TODO(body): (Landroid/view/View;FI)V */ }
    /*
    //         .locals 9
    //         const/4 v8, 0x2
    ...
    */
    ...
    private fun invalidateChildRegion(v: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    private fun isLayoutRtlSupport(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 2
    //         const/4 v0, 0x1
    ...
    */
    ...
    private fun onPanelDragged(newLeft: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 10
    ...
    */
    ...
    private fun openPane(pane: android.view.View, initialVelocity: Int): Boolean { return TODO("body: (Landroid/view/View;I)Z") }
    /*
    //         .locals 2
    //         const/4 v0, 0x1
    //         iget-boolean v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->mFirstLayout:Z
    ...
    */
    ...
    private fun parallaxOtherViews(slideOffset: Float) { /* TODO(body): (F)V */ }
    /*
    //         .locals 12
    ...
    */
    ...
    public fun canSlide(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun closePane(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 2
    ...
    */
    ...
    fun dispatchOnPanelClosed(panel: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    fun dispatchOnPanelOpened(panel: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 1
    //         iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->mPanelSlideListener:Landroid/support/v4/widget/SlidingPaneLayout$PanelSlideListener;
    //         if-eqz v0, :cond_0
    ...
    */
    ...
    fun dispatchOnPanelSlide(panel: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 2
    //         iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->mPanelSlideListener:Landroid/support/v4/widget/SlidingPaneLayout$PanelSlideListener;
    //         if-eqz v0, :cond_0
    ...
    */
    ...
    public fun getCoveredFadeColor(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getParallaxDistance(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getSliderFadeColor(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    ...
    */
    ...
    fun isDimmed(child: android.view.View): Boolean { return TODO("body: (Landroid/view/View;)Z") }
    /*
    //         .locals 4
    //         const/4 v1, 0x0
    //         if-nez p1, :cond_1
    ...
    */
    ...
    public fun isOpen(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 2
    //         iget-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->mCanSlide:Z
    //         if-eqz v0, :cond_0
    ...
    */
    ...
    public fun isSlideable(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 1
    //         iget-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->mCanSlide:Z
    //         return v0
    ...
    */
    ...
    public fun openPane(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 2
    //         iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->mSlideableView:Landroid/view/View;
    //         const/4 v1, 0x0
    ...
    */
    ...
    public fun requestChildFocus(child: android.view.View, focused: android.view.View) { /* TODO(body): (Landroid/view/View;Landroid/view/View;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    fun setAllChildrenVisible() { /* TODO(body): ()V */ }
    /*
    //         .locals 5
    //         const/4 v2, 0x0
    //         .local v2, "i":I
    ...
    */
    ...
    public fun setCoveredFadeColor(color: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setPanelSlideListener(listener: android.support.v4.widget.SlidingPaneLayout.PanelSlideListener) { /* TODO(body): (Landroid/support/v4/widget/SlidingPaneLayout$PanelSlideListener;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setParallaxDistance(parallaxBy: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setShadowDrawable(d: android.graphics.drawable.Drawable) { /* TODO(body): (Landroid/graphics/drawable/Drawable;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setShadowDrawableLeft(d: android.graphics.drawable.Drawable) { /* TODO(body): (Landroid/graphics/drawable/Drawable;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setShadowDrawableRight(d: android.graphics.drawable.Drawable) { /* TODO(body): (Landroid/graphics/drawable/Drawable;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setShadowResource(resId: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun setShadowResourceLeft(resId: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 1
    //         invoke-virtual {p0}, Landroid/support/v4/widget/SlidingPaneLayout;->getResources()Landroid/content/res/Resources;
    //         move-result-object v0
    ...
    */
    ...
    public fun setShadowResourceRight(resId: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 1
    //         invoke-virtual {p0}, Landroid/support/v4/widget/SlidingPaneLayout;->getResources()Landroid/content/res/Resources;
    //         move-result-object v0
    ...
    */
    ...
    public fun setSliderFadeColor(color: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun smoothSlideClosed() { /* TODO(body): ()V */ }
    /*
    //         .locals 0
    //         .annotation runtime Ljava/lang/Deprecated;
    //         .end annotation
    ...
    */
    ...
    public fun smoothSlideOpen() { /* TODO(body): ()V */ }
    /*
    //         .locals 0
    //         .annotation runtime Ljava/lang/Deprecated;
    //         .end annotation
    ...
    */
    ...
    fun smoothSlideTo(slideOffset: Float, velocity: Int): Boolean { return TODO("body: (FI)Z") }
    /*
    //         .locals 9
    //         const/4 v5, 0x0
    ...
    */
    ...
    fun updateObscuredViewsVisibility(panel: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 21
    //         invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/SlidingPaneLayout;->isLayoutRtlSupport()Z
    //         move-result v12
    ...
    */
    ...
    companion object {
    private val DEFAULT_FADE_COLOR: Int = 0
    private val DEFAULT_OVERHANG_SIZE: Int = 0x20
    val IMPL: android.support.v4.widget.SlidingPaneLayout.SlidingPanelLayoutImpl = null!!
    private val MIN_FLING_VELOCITY: Int = 0x190
    private val TAG: String = "SlidingPaneLayout"

    private @JvmStatic fun viewIsOpaque(v: android.view.View): Boolean { return TODO("body: (Landroid/view/View;)Z") }
    /*
    //         .locals 5
    //         const/4 v1, 0x1
    //         const/4 v2, 0x0
