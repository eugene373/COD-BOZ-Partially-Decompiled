...
class SlidingPaneLayout_SavedState_Anon1: android.os.Parcelable.Creator {
    constructor()

    public fun createFromParcel(in: android.os.Parcel): android.support.v4.widget.SlidingPaneLayout.SavedState { return TODO("body: (Landroid/os/Parcel;)Landroid/support/v4/widget/SlidingPaneLayout$SavedState;") }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun newArray(size: Int): Array<android.support.v4.widget.SlidingPaneLayout.SavedState> { return TODO("body: (I)[Landroid/support/v4/widget/SlidingPaneLayout$SavedState;") }
    /*
    //         .locals 1
