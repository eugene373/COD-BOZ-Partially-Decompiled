...
open class DrawerLayout_AccessibilityDelegate: android.support.v4.view.AccessibilityDelegateCompat() {
    private val mTmpRect: android.graphics.Rect
    val this$0: android.support.v4.widget.DrawerLayout

    constructor(p0: android.support.v4.widget.DrawerLayout)

    private fun addChildrenForAccessibility(info: android.support.v4.view.accessibility.AccessibilityNodeInfoCompat, v: android.view.ViewGroup) { /* TODO(body): (Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;Landroid/view/ViewGroup;)V */ }
    /*
    //         .locals 4
