...
// Auto-emitted from smali source: NotificationCompatIceCreamSandwich.java.
// 0 fields, 2 methods.

open class NotificationCompatIceCreamSandwich {
    constructor()

    companion object {
    @JvmStatic fun add(context: android.content.Context, n: android.app.Notification, contentTitle: CharSequence, contentText: CharSequence, contentInfo: CharSequence, tickerView: android.widget.RemoteViews, number: Int, contentIntent: android.app.PendingIntent, fullScreenIntent: android.app.PendingIntent, largeIcon: android.graphics.Bitmap, progressMax: Int, progress: Int, progressIndeterminate: Boolean): android.app.Notification { return TODO("body: (Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZ)Landroid/app/Notification;") }
    /*
    //         .locals 9
