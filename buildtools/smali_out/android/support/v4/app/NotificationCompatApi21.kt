...
open class NotificationCompatApi21 {
    constructor()
    ...
    private val KEY_AUTHOR: String = "author"
    private val KEY_MESSAGES: String = "messages"
    private val KEY_ON_READ: String = "on_read"
    private val KEY_ON_REPLY: String = "on_reply"
    private val KEY_PARTICIPANTS: String = "participants"
    private val KEY_REMOTE_INPUT: String = "remote_input"
    private val KEY_TEXT: String = "text"
    private val KEY_TIMESTAMP: String = "timestamp"

    private @JvmStatic fun fromCompatRemoteInput(src: android.support.v4.app.RemoteInputCompatBase.RemoteInput): android.app.RemoteInput { return TODO("body: (Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput;)Landroid/app/RemoteInput;") }
    /*
    //         .locals 2
    ...
    */
    ...
    @JvmStatic fun getBundleForUnreadConversation(uc: android.support.v4.app.NotificationCompatBase.UnreadConversation): android.os.Bundle { return TODO("body: (Landroid/support/v4/app/NotificationCompatBase$UnreadConversation;)Landroid/os/Bundle;") }
    /*
    //         .locals 10
    //         if-nez p0, :cond_0
    //         const/4 v1, 0x0
    ...
    */
    ...
    @JvmStatic fun getUnreadConversationFromBundle(b: android.os.Bundle, factory: android.support.v4.app.NotificationCompatBase.UnreadConversation.Factory, remoteInputFactory: android.support.v4.app.RemoteInputCompatBase.RemoteInput.Factory): android.support.v4.app.NotificationCompatBase.UnreadConversation { return TODO("body: (Landroid/os/Bundle;Landroid/support/v4/app/NotificationCompatBase$UnreadConversation$Factory;Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput$Factory;)Landroid/support/v4/app/NotificationCompatBase$UnreadConversation;") }
    /*
    //         .locals 13
    //         const/4 v2, 0x0
    //         if-nez p0, :cond_1
    ...
    */
    ...
    private @JvmStatic fun toCompatRemoteInput(remoteInput: android.app.RemoteInput, factory: android.support.v4.app.RemoteInputCompatBase.RemoteInput.Factory): android.support.v4.app.RemoteInputCompatBase.RemoteInput { return TODO("body: (Landroid/app/RemoteInput;Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput$Factory;)Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput;") }
    /*
    //         .locals 6
