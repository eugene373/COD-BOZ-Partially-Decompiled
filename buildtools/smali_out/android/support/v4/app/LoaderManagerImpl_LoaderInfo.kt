...
class LoaderManagerImpl_LoaderInfo: android.support.v4.content.Loader.OnLoadCompleteListener {
    val mArgs: android.os.Bundle
    var mCallbacks: android.support.v4.app.LoaderManager.LoaderCallbacks
    var mData: Object
    var mDeliveredData: Boolean
    var mDestroyed: Boolean
    var mHaveData: Boolean
    val mId: Int
    var mListenerRegistered: Boolean
    var mLoader: android.support.v4.content.Loader
    var mPendingLoader: android.support.v4.app.LoaderManagerImpl.LoaderInfo
    var mReportNextStart: Boolean
    var mRetaining: Boolean
    var mRetainingStarted: Boolean
    var mStarted: Boolean
    val this$0: android.support.v4.app.LoaderManagerImpl

    public constructor(id: android.support.v4.app.LoaderManagerImpl, args: Int, p2: android.os.Bundle, p3: android.support.v4.app.LoaderManager.LoaderCallbacks)

    fun callOnLoadFinished(data: android.support.v4.content.Loader, p1: Object) { /* TODO(body): (Landroid/support/v4/content/Loader;Ljava/lang/Object;)V */ }
    /*
    //         .locals 4
    ...
    */
    ...
    public fun onLoadComplete(data: android.support.v4.content.Loader, p1: Object) { /* TODO(body): (Landroid/support/v4/content/Loader;Ljava/lang/Object;)V */ }
    /*
    //         .locals 6
    //         .local p1, "loader":Landroid/support/v4/content/Loader;, "Landroid/support/v4/content/Loader<Ljava/lang/Object;>;"
    //         const/4 v5, 0x0
