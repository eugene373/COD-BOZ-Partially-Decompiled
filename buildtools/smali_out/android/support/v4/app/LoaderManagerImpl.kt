...
// 10 fields, 20 methods.

open class LoaderManagerImpl: android.support.v4.app.LoaderManager() {
    var mActivity: android.support.v4.app.FragmentActivity
    var mCreatingLoader: Boolean
    val mInactiveLoaders: android.support.v4.util.SparseArrayCompat
    val mLoaders: android.support.v4.util.SparseArrayCompat
    var mRetaining: Boolean
    var mRetainingStarted: Boolean
    var mStarted: Boolean
    val mWho: String

    constructor(who: String, activity: android.support.v4.app.FragmentActivity, started: Boolean)

    private fun createAndInstallLoader(id: Int, args: android.os.Bundle, p2: android.support.v4.app.LoaderManager.LoaderCallbacks): android.support.v4.app.LoaderManagerImpl.LoaderInfo { return TODO("body: (ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;") }
    /*
    //         .locals 3
    ...
    */
    ...
    private fun createLoader(id: Int, args: android.os.Bundle, p2: android.support.v4.app.LoaderManager.LoaderCallbacks): android.support.v4.app.LoaderManagerImpl.LoaderInfo { return TODO("body: (ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;") }
    /*
    //         .locals 2
    //         .local p3, "callback":Landroid/support/v4/app/LoaderManager$LoaderCallbacks;, "Landroid/support/v4/app/LoaderManager$LoaderCallbacks<Ljava/lang/Object;>;"
    ...
    */
    ...
    public fun destroyLoader(id: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 5
    ...
    */
    ...
    fun doReportNextStart() { /* TODO(body): ()V */ }
    /*
    //         .locals 3
    //         iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/util/SparseArrayCompat;
    //         invoke-virtual {v1}, Landroid/support/v4/util/SparseArrayCompat;->size()I
    ...
    */
    ...
    public fun getLoader(id: Int): android.support.v4.content.Loader { return TODO("body: (I)Landroid/support/v4/content/Loader;") }
    /*
    //         .locals 3
    ...
    */
    ...
    public fun initLoader(id: Int, args: android.os.Bundle, p2: android.support.v4.app.LoaderManager.LoaderCallbacks): android.support.v4.content.Loader { return TODO("body: (ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;") }
    /*
    //         .locals 4
    ...
    */
    ...
    fun installLoader(info: android.support.v4.app.LoaderManagerImpl.LoaderInfo) { /* TODO(body): (Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;)V */ }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun restartLoader(id: Int, args: android.os.Bundle, p2: android.support.v4.app.LoaderManager.LoaderCallbacks): android.support.v4.content.Loader { return TODO("body: (ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;") }
    /*
    //         .locals 6
    //         .local p3, "callback":Landroid/support/v4/app/LoaderManager$LoaderCallbacks;, "Landroid/support/v4/app/LoaderManager$LoaderCallbacks<TD;>;"
    //         const/4 v5, 0x0
    ...
    */
    ...
    fun updateActivity(activity: android.support.v4.app.FragmentActivity) { /* TODO(body): (Landroid/support/v4/app/FragmentActivity;)V */ }
    /*
    //         .locals 0
