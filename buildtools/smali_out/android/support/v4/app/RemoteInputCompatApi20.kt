...
// Auto-emitted from smali source: RemoteInputCompatApi20.java.
// 0 fields, 5 methods.

open class RemoteInputCompatApi20 {
    constructor()
    ...
    */
    ...
    @JvmStatic fun fromCompat(srcArray: Array<android.support.v4.app.RemoteInputCompatBase.RemoteInput>): Array<android.app.RemoteInput> { return TODO("body: ([Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput;)[Landroid/app/RemoteInput;") }
    /*
    //         .locals 5
    //         if-nez p0, :cond_1
    //         const/4 v1, 0x0
    ...
    */
    ...
    @JvmStatic fun toCompat(srcArray: Array<android.app.RemoteInput>, factory: android.support.v4.app.RemoteInputCompatBase.RemoteInput.Factory): Array<android.support.v4.app.RemoteInputCompatBase.RemoteInput> { return TODO("body: ([Landroid/app/RemoteInput;Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput$Factory;)[Landroid/support/v4/app/RemoteInputCompatBase$RemoteInput;") }
    /*
    //         .locals 9
    //         if-nez p0, :cond_1
    //         const/4 v7, 0x0
