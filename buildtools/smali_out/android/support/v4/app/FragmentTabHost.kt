...
open class FragmentTabHost: android.widget.TabHost(), android.widget.TabHost.OnTabChangeListener {
    private var mAttached: Boolean
    private var mContainerId: Int
    private var mContext: android.content.Context
    private var mFragmentManager: android.support.v4.app.FragmentManager
    private var mLastTab: android.support.v4.app.FragmentTabHost.TabInfo
    private var mOnTabChangeListener: android.widget.TabHost.OnTabChangeListener
    private var mRealTabContent: android.widget.FrameLayout
    private val mTabs: java.util.ArrayList

    public constructor(context: android.content.Context)

    public constructor(context: android.content.Context, attrs: android.util.AttributeSet)

    private fun doTabChanged(tabId: String, ft: android.support.v4.app.FragmentTransaction): android.support.v4.app.FragmentTransaction { return TODO("body: (Ljava/lang/String;Landroid/support/v4/app/FragmentTransaction;)Landroid/support/v4/app/FragmentTransaction;") }
    /*
    //         .locals 6
    //         const/4 v1, 0x0
    ...
    */
    ...
    private fun ensureContent() { /* TODO(body): ()V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    private fun ensureHierarchy(context: android.content.Context) { /* TODO(body): (Landroid/content/Context;)V */ }
    /*
    //         .locals 8
    //         const v4, 0x1020013
    //         const/4 v7, 0x0
    ...
    */
    ...
    private fun initFragmentTabHost(context: android.content.Context, attrs: android.util.AttributeSet) { /* TODO(body): (Landroid/content/Context;Landroid/util/AttributeSet;)V */ }
    /*
    //         .locals 4
    //         const/4 v3, 0x0
    //         const/4 v1, 0x1
    ...
    */
    ...
    public fun addTab(tabSpec: android.widget.TabHost.TabSpec, args: Class, p2: android.os.Bundle) { /* TODO(body): (Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V */ }
    /*
    //         .locals 5
    ...
    */
    ...
    public fun onTabChanged(tabId: String) { /* TODO(body): (Ljava/lang/String;)V */ }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun setOnTabChangedListener(l: android.widget.TabHost.OnTabChangeListener) { /* TODO(body): (Landroid/widget/TabHost$OnTabChangeListener;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setup(context: android.content.Context, manager: android.support.v4.app.FragmentManager) { /* TODO(body): (Landroid/content/Context;Landroid/support/v4/app/FragmentManager;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setup(context: android.content.Context, manager: android.support.v4.app.FragmentManager, containerId: Int) { /* TODO(body): (Landroid/content/Context;Landroid/support/v4/app/FragmentManager;I)V */ }
    /*
    //         .locals 2
    //         invoke-direct {p0, p1}, Landroid/support/v4/app/FragmentTabHost;->ensureHierarchy(Landroid/content/Context;)V
    //         invoke-super {p0}, Landroid/widget/TabHost;->setup()V
