...
// 10 fields, 14 methods.

open class NotificationManagerCompat_SideChannelManager: android.os.Handler.Callback, android.content.ServiceConnection {
    private var mCachedEnabledPackages: java.util.Set
    private val mContext: android.content.Context
    private val mHandler: android.os.Handler
    private val mHandlerThread: android.os.HandlerThread
    private val mRecordMap: java.util.Map

    public constructor(context: android.content.Context)

    private fun ensureServiceBound(record: android.support.v4.app.NotificationManagerCompat.SideChannelManager.ListenerRecord): Boolean { return TODO("body: (Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)Z") }
    /*
    //         .locals 4
    ...
    */
    ...
    private fun ensureServiceUnbound(record: android.support.v4.app.NotificationManagerCompat.SideChannelManager.ListenerRecord) { /* TODO(body): (Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    private fun handleQueueTask(task: android.support.v4.app.NotificationManagerCompat.Task) { /* TODO(body): (Landroid/support/v4/app/NotificationManagerCompat$Task;)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    private fun handleRetryListenerQueue(componentName: android.content.ComponentName) { /* TODO(body): (Landroid/content/ComponentName;)V */ }
    /*
    //         .locals 2
    ...
    */
    ...
    private fun handleServiceConnected(componentName: android.content.ComponentName, iBinder: android.os.IBinder) { /* TODO(body): (Landroid/content/ComponentName;Landroid/os/IBinder;)V */ }
    /*
    //         .locals 2
    //         iget-object v1, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->mRecordMap:Ljava/util/Map;
    //         invoke-interface {v1, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    */
    ...
    private fun handleServiceDisconnected(componentName: android.content.ComponentName) { /* TODO(body): (Landroid/content/ComponentName;)V */ }
    /*
    //         .locals 2
    //         iget-object v1, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->mRecordMap:Ljava/util/Map;
    //         invoke-interface {v1, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    */
    ...
    private fun processListenerQueue(record: android.support.v4.app.NotificationManagerCompat.SideChannelManager.ListenerRecord) { /* TODO(body): (Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V */ }
    /*
    //         .locals 6
    //         const/4 v5, 0x3
    ...
    */
    ...
    private fun scheduleListenerRetry(record: android.support.v4.app.NotificationManagerCompat.SideChannelManager.ListenerRecord) { /* TODO(body): (Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V */ }
    /*
    //         .locals 6
    //         const/4 v5, 0x3
    ...
    */
    ...
    private fun updateListenerMap() { /* TODO(body): ()V */ }
    /*
    //         .locals 12
    //         const/4 v11, 0x3
    ...
    */
    ...
    public fun onServiceConnected(componentName: android.content.ComponentName, iBinder: android.os.IBinder) { /* TODO(body): (Landroid/content/ComponentName;Landroid/os/IBinder;)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    public fun onServiceDisconnected(componentName: android.content.ComponentName) { /* TODO(body): (Landroid/content/ComponentName;)V */ }
    /*
    //         .locals 3
    //         const-string v0, "NotifManCompat"
    //         const/4 v1, 0x3
    ...
    */
    ...
    public fun queueTask(task: android.support.v4.app.NotificationManagerCompat.Task) { /* TODO(body): (Landroid/support/v4/app/NotificationManagerCompat$Task;)V */ }
    /*
    //         .locals 2
    //         iget-object v0, p0, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->mHandler:Landroid/os/Handler;
    //         const/4 v1, 0x0
    ...
    */
    ...
    companion object {
    private val KEY_BINDER: String = "binder"
    private val MSG_QUEUE_TASK: Int = 0x0
    private val MSG_RETRY_LISTENER_QUEUE: Int = 0x3
    private val MSG_SERVICE_CONNECTED: Int = 0x1
    private val MSG_SERVICE_DISCONNECTED: Int = 0x2
    }
}
