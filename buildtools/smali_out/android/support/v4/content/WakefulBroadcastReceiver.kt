...
// Auto-emitted from smali source: WakefulBroadcastReceiver.java.
// 3 fields, 4 methods.

open class WakefulBroadcastReceiver: android.content.BroadcastReceiver() {
    public constructor()

    companion object {
    private val EXTRA_WAKE_LOCK_ID: String = "android.support.content.wakelockid"
    private val mActiveWakeLocks: android.util.SparseArray = null!!
    private var mNextId: Int

    public @JvmStatic fun completeWakefulIntent(intent: android.content.Intent): Boolean { return TODO("body: (Landroid/content/Intent;)Z") }
    /*
    //         .locals 7
    //         const/4 v3, 0x1
    //         const/4 v2, 0x0
    ...
    */
    ...
    public @JvmStatic fun startWakefulService(context: android.content.Context, intent: android.content.Intent): android.content.ComponentName { return TODO("body: (Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;") }
    /*
    //         .locals 8
