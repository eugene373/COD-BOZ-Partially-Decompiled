...
open class LocalBroadcastManager {
    private val mActions: java.util.HashMap
    private val mAppContext: android.content.Context
    private val mHandler: android.os.Handler
    private val mPendingBroadcasts: java.util.ArrayList
    private val mReceivers: java.util.HashMap

    private constructor(context: android.content.Context)

    private fun executePendingBroadcasts() { /* TODO(body): ()V */ }
    /*
    //         .locals 8
    //         :cond_0
    //         const/4 v2, 0x0
    ...
    */
    ...
    public fun registerReceiver(receiver: android.content.BroadcastReceiver, filter: android.content.IntentFilter) { /* TODO(body): (Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V */ }
    /*
    //         .locals 7
    //         iget-object v6, p0, Landroid/support/v4/content/LocalBroadcastManager;->mReceivers:Ljava/util/HashMap;
    //         monitor-enter v6
    ...
    */
    ...
    public fun sendBroadcast(intent: android.content.Intent): Boolean { return TODO("body: (Landroid/content/Intent;)Z") }
    /*
    //         .locals 17
    ...
    */
    ...
    public fun sendBroadcastSync(intent: android.content.Intent) { /* TODO(body): (Landroid/content/Intent;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun unregisterReceiver(receiver: android.content.BroadcastReceiver) { /* TODO(body): (Landroid/content/BroadcastReceiver;)V */ }
    /*
    //         .locals 9
    ...
    */
    ...
    val MSG_EXEC_PENDING_BROADCASTS: Int = 0x1
    private val TAG: String = "LocalBroadcastManager"
    private var mInstance: android.support.v4.content.LocalBroadcastManager
    private val mLock: Object = null!!

    public @JvmStatic fun getInstance(context: android.content.Context): android.support.v4.content.LocalBroadcastManager { return TODO("body: (Landroid/content/Context;)Landroid/support/v4/content/LocalBroadcastManager;") }
    /*
    //         .locals 3
