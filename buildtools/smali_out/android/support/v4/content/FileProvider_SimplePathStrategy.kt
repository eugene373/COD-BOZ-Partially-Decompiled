...
open class FileProvider_SimplePathStrategy: android.support.v4.content.FileProvider.PathStrategy {
    private val mAuthority: String
    private val mRoots: java.util.HashMap

    public constructor(authority: String)

    public fun addRoot(name: String, root: java.io.File) { /* TODO(body): (Ljava/lang/String;Ljava/io/File;)V */ }
    /*
    //         .locals 4
    ...
    */
    ...
    public fun getFileForUri(uri: android.net.Uri): java.io.File { return TODO("body: (Landroid/net/Uri;)Ljava/io/File;") }
    /*
    //         .locals 9
    //         const/4 v7, 0x1
    ...
    */
    ...
    public fun getUriForFile(file: java.io.File): android.net.Uri { return TODO("body: (Ljava/io/File;)Landroid/net/Uri;") }
    /*
    //         .locals 9
    //         :try_start_0
