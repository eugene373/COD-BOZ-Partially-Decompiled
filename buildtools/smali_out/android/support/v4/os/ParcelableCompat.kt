...
open class ParcelableCompat {
    public constructor()

    companion object {
    public @JvmStatic fun newCreator(p0: android.support.v4.os.ParcelableCompatCreatorCallbacks): android.os.Parcelable.Creator { return TODO("body: (Landroid/support/v4/os/ParcelableCompatCreatorCallbacks;)Landroid/os/Parcelable$Creator;") }
    /*
    //         .locals 2
