...
open class PrintHelperKitkat_Anon2: android.print.PrintDocumentAdapter() {
    var loadBitmap: android.os.AsyncTask
    ...
    val val$imageFile: android.net.Uri
    val val$jobName: String

    constructor(p0: android.support.v4.print.PrintHelperKitkat, p1: String, p2: android.net.Uri, p3: android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback, p4: Int)

    private fun cancelLoad() { /* TODO(body): ()V */ }
    /*
    //         .locals 3
