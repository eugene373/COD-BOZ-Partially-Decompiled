...
// 76 fields, 92 methods.

open class ViewPager: android.view.ViewGroup() {
    private var mActivePointerId: Int
    private var mAdapter: android.support.v4.view.PagerAdapter
    private var mAdapterChangeListener: android.support.v4.view.ViewPager.OnAdapterChangeListener
    private var mBottomPageBounds: Int
    private var mCalledSuper: Boolean
    private var mChildHeightMeasureSpec: Int
    private var mChildWidthMeasureSpec: Int
    private var mCloseEnough: Int
    private var mCurItem: Int
    private var mDecorChildCount: Int
    private var mDefaultGutterSize: Int
    private var mDrawingOrder: Int
    private var mDrawingOrderedChildren: java.util.ArrayList
    private val mEndScrollRunnable: Runnable
    private var mExpectedAdapterCount: Int
    private var mFakeDragBeginTime: Long
    private var mFakeDragging: Boolean
    private var mFirstLayout: Boolean
    private var mFirstOffset: Float
    private var mFlingDistance: Int
    private var mGutterSize: Int
    private var mIgnoreGutter: Boolean
    private var mInLayout: Boolean
    private var mInitialMotionX: Float
    private var mInitialMotionY: Float
    private var mInternalPageChangeListener: android.support.v4.view.ViewPager.OnPageChangeListener
    private var mIsBeingDragged: Boolean
    private var mIsUnableToDrag: Boolean
    private val mItems: java.util.ArrayList
    private var mLastMotionX: Float
    private var mLastMotionY: Float
    private var mLastOffset: Float
    private var mLeftEdge: android.support.v4.widget.EdgeEffectCompat
    private var mMarginDrawable: android.graphics.drawable.Drawable
    private var mMaximumVelocity: Int
    private var mMinimumVelocity: Int
    private var mNeedCalculatePageOffsets: Boolean
    private var mObserver: android.support.v4.view.ViewPager.PagerObserver
    private var mOffscreenPageLimit: Int
    private var mOnPageChangeListener: android.support.v4.view.ViewPager.OnPageChangeListener
    private var mPageMargin: Int
    private var mPageTransformer: android.support.v4.view.ViewPager.PageTransformer
    private var mPopulatePending: Boolean
    private var mRestoredAdapterState: android.os.Parcelable
    private var mRestoredClassLoader: ClassLoader
    private var mRestoredCurItem: Int
    private var mRightEdge: android.support.v4.widget.EdgeEffectCompat
    private var mScrollState: Int
    private var mScroller: android.widget.Scroller
    private var mScrollingCacheEnabled: Boolean
    private var mSetChildrenDrawingOrderEnabled: java.lang.reflect.Method
    private val mTempItem: android.support.v4.view.ViewPager.ItemInfo
    private val mTempRect: android.graphics.Rect
    private var mTopPageBounds: Int
    private var mTouchSlop: Int
    private var mVelocityTracker: android.view.VelocityTracker

    public constructor(context: android.content.Context)

    public constructor(context: android.content.Context, attrs: android.util.AttributeSet)

    private fun calculatePageOffsets(curItem: android.support.v4.view.ViewPager.ItemInfo, curIndex: Int, oldCurInfo: android.support.v4.view.ViewPager.ItemInfo) { /* TODO(body): (Landroid/support/v4/view/ViewPager$ItemInfo;ILandroid/support/v4/view/ViewPager$ItemInfo;)V */ }
    /*
    //         .locals 14
    ...
    */
    ...
    private fun completeScroll(postEvents: Boolean) { /* TODO(body): (Z)V */ }
    /*
    //         .locals 10
    //         const/4 v7, 0x0
    ...
    */
    ...
    private fun determineTargetPage(currentPage: Int, pageOffset: Float, velocity: Int, deltaX: Int): Int { return TODO("body: (IFII)I") }
    /*
    //         .locals 6
    ...
    */
    ...
    private fun enableLayers(enable: Boolean) { /* TODO(body): (Z)V */ }
    /*
    //         .locals 5
    ...
    */
    ...
    private fun endDrag() { /* TODO(body): ()V */ }
    /*
    //         .locals 1
    //         const/4 v0, 0x0
    ...
    */
    ...
    private fun getChildRectInPagerCoordinates(outRect: android.graphics.Rect, child: android.view.View): android.graphics.Rect { return TODO("body: (Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;") }
    /*
    //         .locals 4
    //         const/4 v2, 0x0
    //         if-nez p1, :cond_0
    ...
    */
    ...
    private fun getClientWidth(): Int { return TODO("body: ()I") }
    /*
    //         .locals 2
    ...
    */
    ...
    private fun infoForCurrentScrollPosition(): android.support.v4.view.ViewPager.ItemInfo { return TODO("body: ()Landroid/support/v4/view/ViewPager$ItemInfo;") }
    /*
    //         .locals 15
    //         const/4 v8, 0x0
    //         invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->getClientWidth()I
    ...
    */
    ...
    private fun isGutterDrag(x: Float, dx: Float): Boolean { return TODO("body: (FF)Z") }
    /*
    //         .locals 3
    //         const/4 v2, 0x0
    ...
    */
    ...
    private fun pageScrolled(xpos: Int): Boolean { return TODO("body: (I)Z") }
    /*
    //         .locals 10
    //         const/4 v7, 0x0
    //         iget-object v8, p0, Landroid/support/v4/view/ViewPager;->mItems:Ljava/util/ArrayList;
    ...
    */
    ...
    private fun performDrag(x: Float): Boolean { return TODO("body: (F)Z") }
    /*
    //         .locals 17
    //         const/4 v7, 0x0
    ...
    */
    ...
    private fun recomputeScrollPosition(width: Int, oldWidth: Int, margin: Int, oldMargin: Int) { /* TODO(body): (IIII)V */ }
    /*
    //         .locals 14
    //         if-lez p2, :cond_1
    ...
    */
    ...
    private fun removeNonDecorViews() { /* TODO(body): ()V */ }
    /*
    //         .locals 4
    //         const/4 v1, 0x0
    //         .local v1, "i":I
    ...
    */
    ...
    private fun requestParentDisallowInterceptTouchEvent(disallowIntercept: Boolean) { /* TODO(body): (Z)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    private fun scrollToItem(item: Int, smoothScroll: Boolean, velocity: Int, dispatchSelected: Boolean) { /* TODO(body): (IZIZ)V */ }
    /*
    //         .locals 8
    //         const/4 v7, 0x0
    ...
    */
    ...
    private fun setScrollState(newState: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    private fun setScrollingCacheEnabled(enabled: Boolean) { /* TODO(body): (Z)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    private fun sortChildDrawingOrder() { /* TODO(body): ()V */ }
    /*
    //         .locals 5
    ...
    */
    ...
    public fun addFocusables(direction: java.util.ArrayList, focusableMode: Int, p2: Int) { /* TODO(body): (Ljava/util/ArrayList;II)V */ }
    /*
    //         .locals 7
    ...
    */
    ...
    fun addNewItem(position: Int, index: Int): android.support.v4.view.ViewPager.ItemInfo { return TODO("body: (II)Landroid/support/v4/view/ViewPager$ItemInfo;") }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun addTouchables(p0: java.util.ArrayList) { /* TODO(body): (Ljava/util/ArrayList;)V */ }
    /*
    //         .locals 5
    ...
    */
    ...
    public fun addView(child: android.view.View, index: Int, params: android.view.ViewGroup.LayoutParams) { /* TODO(body): (Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V */ }
    /*
    //         .locals 3
    ...
    */
    ...
    public fun arrowScroll(direction: Int): Boolean { return TODO("body: (I)Z") }
    /*
    //         .locals 13
    //         const/16 v12, 0x42
    //         const/16 v11, 0x11
    ...
    */
    ...
    public fun beginFakeDrag(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 10
    //         const/4 v9, 0x1
    //         const/4 v4, 0x0
    ...
    */
    ...
    protected fun canScroll(v: android.view.View, checkV: Boolean, dx: Int, x: Int, y: Int): Boolean { return TODO("body: (Landroid/view/View;ZIII)Z") }
    /*
    //         .locals 11
    ...
    */
    ...
    public fun canScrollHorizontally(direction: Int): Boolean { return TODO("body: (I)Z") }
    /*
    //         .locals 6
    //         const/4 v2, 0x1
    //         const/4 v3, 0x0
    ...
    */
    ...
    protected fun checkLayoutParams(p: android.view.ViewGroup.LayoutParams): Boolean { return TODO("body: (Landroid/view/ViewGroup$LayoutParams;)Z") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun computeScroll() { /* TODO(body): ()V */ }
    /*
    //         .locals 5
    ...
    */
    ...
    fun dataSetChanged() { /* TODO(body): ()V */ }
    /*
    //         .locals 15
    //         const/4 v10, 0x1
    //         const/4 v11, 0x0
    ...
    */
    ...
    public fun dispatchPopulateAccessibilityEvent(event: android.view.accessibility.AccessibilityEvent): Boolean { return TODO("body: (Landroid/view/accessibility/AccessibilityEvent;)Z") }
    /*
    //         .locals 6
    ...
    */
    ...
    fun distanceInfluenceForSnapDuration(f: Float): Float { return TODO("body: (F)F") }
    /*
    //         .locals 4
    ...
    */
    ...
    protected fun drawableStateChanged() { /* TODO(body): ()V */ }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun endFakeDrag() { /* TODO(body): ()V */ }
    /*
    //         .locals 12
    //         const/4 v11, 0x1
    ...
    */
    ...
    public fun executeKeyEvent(event: android.view.KeyEvent): Boolean { return TODO("body: (Landroid/view/KeyEvent;)Z") }
    /*
    //         .locals 4
    //         const/4 v3, 0x1
    //         const/4 v0, 0x0
    ...
    */
    ...
    public fun fakeDragBy(xOffset: Float) { /* TODO(body): (F)V */ }
    /*
    //         .locals 18
    //         move-object/from16 v0, p0
    ...
    */
    ...
    protected fun generateDefaultLayoutParams(): android.view.ViewGroup.LayoutParams { return TODO("body: ()Landroid/view/ViewGroup$LayoutParams;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun generateLayoutParams(attrs: android.util.AttributeSet): android.view.ViewGroup.LayoutParams { return TODO("body: (Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;") }
    /*
    //         .locals 2
    //         new-instance v0, Landroid/support/v4/view/ViewPager$LayoutParams;
    ...
    */
    ...
    protected fun generateLayoutParams(p: android.view.ViewGroup.LayoutParams): android.view.ViewGroup.LayoutParams { return TODO("body: (Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getAdapter(): android.support.v4.view.PagerAdapter { return TODO("body: ()Landroid/support/v4/view/PagerAdapter;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getCurrentItem(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    //         iget v0, p0, Landroid/support/v4/view/ViewPager;->mCurItem:I
    //         return v0
    */
    ...
    public fun getOffscreenPageLimit(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getPageMargin(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    ...
    */
    ...
    fun infoForAnyChild(child: android.view.View): android.support.v4.view.ViewPager.ItemInfo { return TODO("body: (Landroid/view/View;)Landroid/support/v4/view/ViewPager$ItemInfo;") }
    /*
    //         .locals 2
    //         :goto_0
    ...
    */
    ...
    fun infoForChild(child: android.view.View): android.support.v4.view.ViewPager.ItemInfo { return TODO("body: (Landroid/view/View;)Landroid/support/v4/view/ViewPager$ItemInfo;") }
    /*
    //         .locals 4
    //         const/4 v0, 0x0
    //         .local v0, "i":I
    ...
    */
    ...
    fun infoForPosition(position: Int): android.support.v4.view.ViewPager.ItemInfo { return TODO("body: (I)Landroid/support/v4/view/ViewPager$ItemInfo;") }
    /*
    //         .locals 3
    //         const/4 v0, 0x0
    //         .local v0, "i":I
    ...
    */
    ...
    public fun isFakeDragging(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 1
    ...
    */
    ...
    protected fun onPageScrolled(position: Int, offset: Float, offsetPixels: Int) { /* TODO(body): (IFI)V */ }
    /*
    //         .locals 17
    //         move-object/from16 v0, p0
    ...
    */
    ...
    protected fun onRequestFocusInDescendants(direction: Int, previouslyFocusedRect: android.graphics.Rect): Boolean { return TODO("body: (ILandroid/graphics/Rect;)Z") }
    /*
    //         .locals 9
    //         invoke-virtual {p0}, Landroid/support/v4/view/ViewPager;->getChildCount()I
    //         move-result v1
    ...
    */
    ...
    public fun onRestoreInstanceState(state: android.os.Parcelable) { /* TODO(body): (Landroid/os/Parcelable;)V */ }
    /*
    //         .locals 4
    ...
    */
    ...
    public fun onSaveInstanceState(): android.os.Parcelable { return TODO("body: ()Landroid/os/Parcelable;") }
    /*
    //         .locals 3
    ...
    */
    ...
    protected fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) { /* TODO(body): (IIII)V */ }
    /*
    //         .locals 2
    ...
    */
    ...
    fun pageLeft(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 2
    //         const/4 v0, 0x1
    ...
    */
    ...
    fun pageRight(): Boolean { return TODO("body: ()Z") }
    /*
    //         .locals 3
    //         const/4 v0, 0x1
    //         iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Landroid/support/v4/view/PagerAdapter;
    ...
    */
    ...
    fun populate(newCurrentItem: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 30
    //         const/16 v21, 0x0
    ...
    */
    ...
    public fun removeView(view: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun setAdapter(adapter: android.support.v4.view.PagerAdapter) { /* TODO(body): (Landroid/support/v4/view/PagerAdapter;)V */ }
    /*
    //         .locals 10
    //         const/4 v9, 0x1
    //         const/4 v8, 0x0
    ...
    */
    ...
    fun setChildrenDrawingOrderEnabledCompat(enable: Boolean) { /* TODO(body): (Z)V */ }
    /*
    //         .locals 6
    //         sget v1, Landroid/os/Build$VERSION;->SDK_INT:I
    //         const/4 v2, 0x7
    ...
    */
    ...
    public fun setCurrentItem(item: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 2
    //         const/4 v1, 0x0
    ...
    */
    ...
    public fun setCurrentItem(item: Int, smoothScroll: Boolean) { /* TODO(body): (IZ)V */ }
    /*
    //         .locals 1
    //         const/4 v0, 0x0
    //         iput-boolean v0, p0, Landroid/support/v4/view/ViewPager;->mPopulatePending:Z
    ...
    */
    ...
    fun setCurrentItemInternal(item: Int, smoothScroll: Boolean, always: Boolean) { /* TODO(body): (IZZ)V */ }
    /*
    //         .locals 1
    //         const/4 v0, 0x0
    ...
    */
    ...
    fun setCurrentItemInternal(item: Int, smoothScroll: Boolean, always: Boolean, velocity: Int) { /* TODO(body): (IZZI)V */ }
    /*
    //         .locals 5
    //         const/4 v0, 0x1
    //         const/4 v4, 0x0
    ...
    */
    ...
    fun setInternalPageChangeListener(listener: android.support.v4.view.ViewPager.OnPageChangeListener): android.support.v4.view.ViewPager.OnPageChangeListener { return TODO("body: (Landroid/support/v4/view/ViewPager$OnPageChangeListener;)Landroid/support/v4/view/ViewPager$OnPageChangeListener;") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun setOffscreenPageLimit(limit: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 4
    //         const/4 v3, 0x1
    //         if-ge p1, v3, :cond_0
    ...
    */
    ...
    fun setOnAdapterChangeListener(listener: android.support.v4.view.ViewPager.OnAdapterChangeListener) { /* TODO(body): (Landroid/support/v4/view/ViewPager$OnAdapterChangeListener;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setOnPageChangeListener(listener: android.support.v4.view.ViewPager.OnPageChangeListener) { /* TODO(body): (Landroid/support/v4/view/ViewPager$OnPageChangeListener;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setPageMargin(marginPixels: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 2
    //         iget v0, p0, Landroid/support/v4/view/ViewPager;->mPageMargin:I
    ...
    */
    ...
    public fun setPageMarginDrawable(resId: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 1
    //         invoke-virtual {p0}, Landroid/support/v4/view/ViewPager;->getContext()Landroid/content/Context;
    //         move-result-object v0
    ...
    */
    ...
    public fun setPageMarginDrawable(d: android.graphics.drawable.Drawable) { /* TODO(body): (Landroid/graphics/drawable/Drawable;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun setPageTransformer(reverseDrawingOrder: Boolean, transformer: android.support.v4.view.ViewPager.PageTransformer) { /* TODO(body): (ZLandroid/support/v4/view/ViewPager$PageTransformer;)V */ }
    /*
    //         .locals 6
    //         const/4 v2, 0x1
    //         const/4 v3, 0x0
    ...
    */
    ...
    fun smoothScrollTo(x: Int, y: Int) { /* TODO(body): (II)V */ }
    /*
    //         .locals 1
    //         const/4 v0, 0x0
    ...
    */
    ...
    fun smoothScrollTo(x: Int, y: Int, velocity: Int) { /* TODO(body): (III)V */ }
    /*
    //         .locals 15
    //         invoke-virtual {p0}, Landroid/support/v4/view/ViewPager;->getChildCount()I
    //         move-result v1
    ...
    */
    ...
    protected fun verifyDrawable(who: android.graphics.drawable.Drawable): Boolean { return TODO("body: (Landroid/graphics/drawable/Drawable;)Z") }
    /*
    //         .locals 1
    ...
    */
    ...
    companion object {
    private val CLOSE_ENOUGH: Int = 0x2
    private val COMPARATOR: java.util.Comparator = null!!
    private val DEBUG: Boolean = false
    private val DEFAULT_GUTTER_SIZE: Int = 0x10
    private val DEFAULT_OFFSCREEN_PAGES: Int = 0x1
    private val DRAW_ORDER_DEFAULT: Int = 0x0
    private val DRAW_ORDER_FORWARD: Int = 0x1
    private val DRAW_ORDER_REVERSE: Int = 0x2
    private val INVALID_POINTER: Int = 0
    private val LAYOUT_ATTRS: IntArray = null!!
    private val MAX_SETTLE_DURATION: Int = 0x258
    private val MIN_DISTANCE_FOR_FLING: Int = 0x19
    private val MIN_FLING_VELOCITY: Int = 0x190
    @JvmField public val SCROLL_STATE_DRAGGING: Int = 0x1
    @JvmField public val SCROLL_STATE_IDLE: Int = 0x0
    @JvmField public val SCROLL_STATE_SETTLING: Int = 0x2
    private val TAG: String = "ViewPager"
    private val USE_CACHE: Boolean = false
    private val sInterpolator: android.view.animation.Interpolator = null!!
    private val sPositionComparator: android.support.v4.view.ViewPager.ViewPositionComparator = null!!
    }
}
