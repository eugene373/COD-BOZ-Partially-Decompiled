...
open class GestureDetectorCompat_GestureDetectorCompatImplBase: android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImpl {
    private var mAlwaysInBiggerTapRegion: Boolean
    private var mAlwaysInTapRegion: Boolean
    private var mCurrentDownEvent: android.view.MotionEvent
    private var mDeferConfirmSingleTap: Boolean
    private var mDoubleTapListener: android.view.GestureDetector.OnDoubleTapListener
    private var mDoubleTapSlopSquare: Int
    private var mDownFocusX: Float
    private var mDownFocusY: Float
    private val mHandler: android.os.Handler
    private var mInLongPress: Boolean
    private var mIsDoubleTapping: Boolean
    private var mIsLongpressEnabled: Boolean
    private var mLastFocusX: Float
    private var mLastFocusY: Float
    private val mListener: android.view.GestureDetector.OnGestureListener
    private var mMaximumFlingVelocity: Int
    private var mMinimumFlingVelocity: Int
    private var mPreviousUpEvent: android.view.MotionEvent
    private var mStillDown: Boolean
    private var mTouchSlopSquare: Int
    ...
    private fun cancel() { /* TODO(body): ()V */ }
    /*
    //         .locals 3
    //         const/4 v2, 0x0
    ...
    */
    ...
    private fun cancelTaps() { /* TODO(body): ()V */ }
    /*
    //         .locals 3
    //         const/4 v2, 0x0
    //         iget-object v0, p0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mHandler:Landroid/os/Handler;
    ...
    */
    ...
    private fun dispatchLongPress() { /* TODO(body): ()V */ }
    /*
    //         .locals 2
    //         iget-object v0, p0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mHandler:Landroid/os/Handler;
    //         const/4 v1, 0x3
    ...
    */
    ...
    private fun init(context: android.content.Context) { /* TODO(body): (Landroid/content/Context;)V */ }
    /*
    //         .locals 5
    //         if-nez p1, :cond_0
    ...
    */
    ...
    private fun isConsideredDoubleTap(firstDown: android.view.MotionEvent, firstUp: android.view.MotionEvent, secondDown: android.view.MotionEvent): Boolean { return TODO("body: (Landroid/view/MotionEvent;Landroid/view/MotionEvent;Landroid/view/MotionEvent;)Z") }
    /*
    //         .locals 8
    //         const/4 v2, 0x0
    ...
    */
    ...
    public fun setIsLongpressEnabled(isLongpressEnabled: Boolean) { /* TODO(body): (Z)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun setOnDoubleTapListener(onDoubleTapListener: android.view.GestureDetector.OnDoubleTapListener) { /* TODO(body): (Landroid/view/GestureDetector$OnDoubleTapListener;)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    companion object {
    private val DOUBLE_TAP_TIMEOUT: Int = 0
    private val LONGPRESS_TIMEOUT: Int = 0
    private val LONG_PRESS: Int = 0x2
    private val SHOW_PRESS: Int = 0x1
    private val TAP: Int = 0x3
    private val TAP_TIMEOUT: Int = 0
    }
}
