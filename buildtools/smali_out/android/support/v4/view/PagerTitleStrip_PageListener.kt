...
open class PagerTitleStrip_PageListener: android.database.DataSetObserver(), android.support.v4.view.ViewPager.OnPageChangeListener, android.support.v4.view.ViewPager.OnAdapterChangeListener {
    private var mScrollState: Int
    val this$0: android.support.v4.view.PagerTitleStrip

    private constructor(p0: android.support.v4.view.PagerTitleStrip)

    constructor(x0: android.support.v4.view.PagerTitleStrip, x1: android.support.v4.view.PagerTitleStrip.1)

    public fun onAdapterChanged(oldAdapter: android.support.v4.view.PagerAdapter, newAdapter: android.support.v4.view.PagerAdapter) { /* TODO(body): (Landroid/support/v4/view/PagerAdapter;Landroid/support/v4/view/PagerAdapter;)V */ }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun onPageScrollStateChanged(state: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 0
    ...
    */
    ...
    public fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) { /* TODO(body): (IFI)V */ }
    /*
    //         .locals 2
    ...
    */
    ...
    public fun onPageSelected(position: Int) { /* TODO(body): (I)V */ }
    /*
    //         .locals 4
    //         const/4 v0, 0x0
