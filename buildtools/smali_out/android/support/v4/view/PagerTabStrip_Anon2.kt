...
open class PagerTabStrip_Anon2: android.view.View.OnClickListener {
    val this$0: android.support.v4.view.PagerTabStrip

    constructor(p0: android.support.v4.view.PagerTabStrip)

    public fun onClick(v: android.view.View) { /* TODO(body): (Landroid/view/View;)V */ }
    /*
    //         .locals 2
