...
open class GameHelper_SignInFailureReason {
    var mActivityResultCode: Int
    var mServiceErrorCode: Int

    public constructor(p0: Int)

    public constructor(p0: Int, p1: Int)

    public fun getActivityResultCode(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
    ...
    */
    ...
    public fun getServiceErrorCode(): Int { return TODO("body: ()I") }
    /*
    //         .locals 1
